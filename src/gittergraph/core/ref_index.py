...
class RefIndex:
    ...
    def __init__(self, branches: dict[str, Branch], tags: dict[str, Tag]) -> None:
        """
    ...
    def _build_index_branches(self, branches: dict[str, Branch]) -> None:
        """
    ...
    def _build_index_tags(self, tags: dict[str, Tag]) -> None:
        """
